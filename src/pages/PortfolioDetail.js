      ...
      <ContentWrapper isDay={isDayTheme}>
        <div className="type-wrap">
          {currentProject?.type?.map((type) => {
            const badge = badgeType.find(
              (badge) => badge.name === type.toLocaleLowerCase(),
            );
            return (
              <p
                className="type"
        ...
        <div style={{ width: "100%" }}>
          <div
            ...
            style={{
              backgroundColor:
                currentProject.name == "Driven" ||
                currentProject.name == "WOOTEEK"
                  ? "black"
                  : "",
            }}
          >
            ...
            <div className="project-content">
              ...
              <div className="project-section">
                <p className="project-section-title">
                  Main Responsibilities & Tools Used
                </p>
...
const ContentWrapper = styled.div`
  ...
  .project-detail-wrapper {
    ...
    .project-side-bar {
      ...
      .side-bar-title {
        color: ${({ isDay }) =>
          isDay ? "var(--color-background-600)" : "rgba(225,225,225,0.8)"};
        font-weight: 600;
        margin-bottom: 16px;
      }
      .side-bar-content {
...
const works = [
  {
    ...
    name: "WOOTEEK",
    description:
      "다양한 브랜드와 트렌드를 한곳에서 즐기는 가상의 복합 쇼핑 반응형 웹 어플리케이션",
