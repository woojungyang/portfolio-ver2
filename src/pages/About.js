      ...
      <ContentWrapper isDay={isDayTheme}>
        <div className="emotion-bg">
          <img
            src={
              isDayTheme
                ? require("assets/img/main5.png")
                : require("assets/img/main4.png")
            }
          />
        </div>
        <div className="intro-title-wrap">
          ...
          <p className="description">
            안녕하세요, 프론트엔드 개발자 양우정입니다. 사용자 경험을 개선하고
            성능을 최적화하는 데 주력하며, 최신 웹 기술을 활용해 직관적이면서도
            창의적인 UI/UX를 구현하는 데 열정을 가지고 있습니다. 또한,
            프로젝트의 성공을 위해 원활한 소통과 협업을 중요시하고, 지속적인
            성장을 목표로 노력하고 있습니다.
          </p>
          <div
...
const ContentWrapper = styled.div`
  ...
  .emotion-bg {
    ...
    img {
      ...
      aspect-ratio: 1;
      box-shadow:
        0 3px 6px hsla(var(--color-dark-300), 0.16),
    ...
    .skill-wrap {
      ...
      .skill {
        ...
        background-color: ${({ isDay }) =>
          isDay ? "transparent" : "rgba(225,225,225,0.4)"};
        border: ${({ isDay }) =>
          isDay ? " 1px solid var(--color-background-400)" : "none"};
        span {
          margin-left: 5px;
          font-size: 14px;
        }
  ...
  .intro-title-wrap {
    ...
    hr {
      ...
      border: 7px solid
        ${({ isDay }) =>
          isDay ? "var(--color-dark-300)" : "var(--color-background-100)"};
      margin-bottom: 80px;
