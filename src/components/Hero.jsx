    ...
    <section id="home" className="flex min-h-screen items-center">
      <div className="container flex flex-col-reverse items-center justify-between gap-y-12 md:flex-row">
        ...
        className="relative flex flex-col items-center gap-y-7 text-center md:w-1/2 md:items-start md:text-start ">
          <Arrow01 style={{ "--secondary": "#6C752D", "--primary": "#e1B3B3" }} className="absolute right-0 top-0 hidden w-16 -translate-y-full sm:block lg:w-20" />
          <div className=" flex flex-col gap-y-4">
            <h1 className="text-h1 font-bold">
              Hi, Im'<span className="text-secondary-50"> Woojung Yang</span>
            </h1>
            <h2 className="text-h2 text-gray-90">
              ...
              <span className="text-primary-50">
                <Typewriter
                  ...
                  typeSpeed={80}
                  loop={0}
                  words={["Front-end Developer", "Creative Developer"]}
                />
              </span>
            </h2>
          ...
          <Arrow02 style={{ "--secondary": "#6C752D", "--primary": "#e1B3B3" }} className="absolute -bottom-4 left-0 hidden w-12 translate-y-full md:block lg:w-16"/>
        </motion.div>
        {/* right side */}
        <motion.div variants={rightSideVariants}
        initial="hidden"
        animate="visible" className="relative flex h-full justify-end md:w-1/2">
          <img src={require('src/assets/img/cta-1.png')} alt="woojungyang" className="w-full max-2-80 md:max-w-[75%]" />
          <Lines tyle={{ "--secondary": "#6C752D" }} className="absolute -top-3 w-10 md:w-14"/>
        </motion.div>
      </div>
    </section>
  );
