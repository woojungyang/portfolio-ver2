            ...
            {tags.map((tag) => (
              <span
                ...
                className={classNames(
                  "flex h-7 items-center justify-center rounded-full text-white border-solid  px-4 text-sm font-normal bg-opacity-80",
                  ...
                  { "bg-[#4A8D84]": tag === "HTML5 / JQuery" },
                  { "bg-[#AD9275]": tag === "Responsive" },
                  { "bg-[#C46F4E]": tag === "Web Development" },
                  { "bg-[#6DBDB2]": tag === "Mobile Development" },
                )}
              >
                {tag}
              </span>
  ...
  return (
    <section id="portfolio">
      <div className="container relative flex flex-col items-center gap-y-9">
        <SectionTitle title="Portfolio" subtitle="Web & App Development" />
...
const projects = [
  {
    id: 1,
    tags: ["Toy", "React", "Responsive", "Web Development"],
    name: "WOOTEEK",
    description:
  ...
  {
    id: 2,
    tags: ["Professional", "Next", "Web Development"],
    name: "ONEMOVE",
    description:
  ...
  {
    id: 4,
    tags: ["Professional", "React", "Web Development"],
    name: "사수래",
    description:
  ...
  {
    id: 7,
    tags: ["Professional", "HTML5 / JQuery", "Responsive", "Web Development"],
    name: "Driven",
    description:
